...
DROP TABLE IF EXISTS "public".musiciens CASCADE;
DROP TABLE IF EXISTS "public".albums CASCADE;
DROP TABLE IF EXISTS "public".sons CASCADE;
DROP TABLE IF EXISTS "public".instruments CASCADE;
DROP TABLE IF EXISTS "public".link_musiciens_instruments CASCADE;
...
CREATE TABLE "public".sons (
    ...
    compositeur_id integer REFERENCES "public".musiciens (id)
) ;
...
CREATE TABLE "public".link_musiciens_instruments (
    id serial PRIMARY KEY,
    musicien_id integer REFERENCES "public".musiciens (id),
    instrument_id integer REFERENCES "public".instruments (id)
) ;

INSERT INTO "public".groupes (nom, date_creation)
VALUES
    ('GIMS', '2002-01-01'),
...
;
INSERT INTO "public".musiciens (prenom, nom, date_naissance, groupe_id)
VALUES
...
INSERT INTO "public".albums (nom, date_sortie, label, groupe_id)
VALUES
...
;
INSERT INTO "public".sons (nom, numero, duree, streams, album_id, compositeur_id)
VALUES
...
;
INSERT INTO "public".instruments (nom)
VALUES
    ('voix'),
    ('guitare'),
    ('clavier'),
    ...
    ('batterie')
;
INSERT INTO "public".link_musiciens_instruments (musicien_id, instrument_id)
VALUES
    (1, 1),
    (2, 1),
    (2, 2),
